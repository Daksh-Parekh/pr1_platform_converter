...
import 'package:pr1_platform_converter/views/bottom_navigation_page/views/tab_bar_ios.dart';
...
class AppRoutes {
  ...
  static Map<String, Widget Function(BuildContext)> iOSRoutes = {
    '/': (context) => TabBarIos(),
    '/home_ios_page': (context) => HomeIosPage(),
    '/detail_iOS_Page': (context) => DetailIosPage(),
    '/add_contact_iOS_Page': (context) => AddContactIosPage(),
    '/recent_ios_page': (context) => RecentIosPage(),
    '/favourite_ios_page': (context) => FavouriteIosPage(),
  };
}
